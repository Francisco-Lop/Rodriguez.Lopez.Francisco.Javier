...
l_00004b: st  	 -X, 	 r16	 ; (OP_ST_XS, 16)
    ...
    ; Turn on the pull-ups, and drive the outputs low to start
          ...
          ldi 	 r31, 	 0x0	 ; (OP_LDI, ZH, (addr >> 8))
          ldi 	 r25, 	 0x13	 ; (OP_LDI, r25, val, lit) ; val=19 lit=0x0=0
          st  	 Z+, 	 r25	 ; (OP_ST_ZP, r25, 0, name)
          ...
          st  	 Z+, 	 r25	 ; (OP_ST_ZP, r25, 0, name)
    ; Begin Of PLC Cycle
l_000066: sbis 	 0x16, 	 1	 ; (OP_SBIS, addr - __SFR_OFFSET, bit)
          rjmp 	 l_000066 	 ; (OP_RJMP, AvrProg.size() - std::min(skbs, uint32_t(2)))
          sbi 	 0x16, 	 1	 ; (OP_SBI, addr - __SFR_OFFSET, bit, name)
    ; Watchdog reset
          wdr 	 		 ; (OP_WDR)
    ...
    ; start series [
    ; ELEM_CONTACTS
    ; INT_IF_BIT_CLEAR Xswitch1
          sbic 	 0x03, 	 0	 ; (OP_SBIC, addr - __SFR_OFFSET, bit, name) ; Xswitch1
          rjmp 	 l_000076 	 ; (OP_RJMP, condFalse)
    ; INT_CLEAR_BIT $rung_top
          ...
          st  	 Z, 	 r25	 ; (OP_ST_Z, reg)
    ; ELEM_COIL
    ; INT_COPY_BIT_TO_BIT Ytenue1:=$rung_top
l_000076: ldi 	 r30, 	 0x0	 ; (OP_LDI, ZL, (addr & 0xff), comment)
          ldi 	 r31, 	 0x1	 ; (OP_LDI, ZH, (addr >> 8))
          ...
          st  	 Z, 	 r25	 ; (OP_ST_Z, r25, 0, name1) ; Ytenue1
    ; ] finish series
    ; 
    ; ======= START RUNG 2 =======
    ...
    ; start series [
    ; ELEM_CONTACTS
    ; INT_IF_BIT_CLEAR Xswitch3
          sbic 	 0x03, 	 4	 ; (OP_SBIC, addr - __SFR_OFFSET, bit, name) ; Xswitch3
    ...
    ; INT_CLEAR_BIT $rung_top
          ...
          st  	 Z, 	 r25	 ; (OP_ST_Z, reg)
    ; ELEM_COIL
    ; INT_COPY_BIT_TO_BIT Ytenue2:=$rung_top
l_00008b: ldi 	 r30, 	 0x0	 ; (OP_LDI, ZL, (addr & 0xff), comment)
          ...
          st  	 Z, 	 r25	 ; (OP_ST_Z, r25, 0, name1) ; Ytenue2
    ; ] finish series
    ; 
    ; ======= START RUNG 3 =======
    ...
    ; start series [
    ; ELEM_CONTACTS
    ; INT_IF_BIT_CLEAR Xswitch2
          sbic 	 0x03, 	 1	 ; (OP_SBIC, addr - __SFR_OFFSET, bit, name) ; Xswitch2
          rjmp 	 l_0000a0 	 ; (OP_RJMP, condFalse)
    ; INT_CLEAR_BIT $rung_top
          ldi 	 r30, 	 0x0	 ; (OP_LDI, ZL, (addr & 0xff), comment)
          ldi 	 r31, 	 0x1	 ; (OP_LDI, ZH, (addr >> 8))
          ld  	 r25, 	 Z	 ; (OP_LD_Z, reg, 0, name) ; $rung_top
    ...
    ; GOTO next PLC cycle
l_0000a0: ldi 	 r30, 	 0x66	 ; (OP_LDI, ZL, addr & 0xff)
          ldi 	 r31, 	 0x0	 ; (OP_LDI, ZH, (addr >> 8) & 0xff)
          ijmp 	 		 ; (OP_IJMP, addr)
l_0000a3: rjmp 	 l_0000a3 	 ; (OP_RJMP, AvrProg.size())
